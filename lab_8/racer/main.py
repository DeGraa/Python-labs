...
background = pygame.image.load("lab_8/racer/img/AnimatedStreet.png")
bg_img = pygame.image.load("lab_8/racer/img/black-background.jpg")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, exclude):
        super().__init__()
        self.image = pygame.image.load("lab_8/racer/img/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, exclude):
        ...
        self.image = pygame.transform.scale(
            pygame.image.load("lab_8/racer/img/transparent_coin.png"),
            (60, 60),
        )
        self.rect = self.image.get_rect()
        self.rect.center = get_random_position(exclude)
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab_8/racer/img/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("lab_8/racer/sound/crash.wav").play()
        time.sleep(1)
